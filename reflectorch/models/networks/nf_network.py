...
from reflectorch.ml.trainers import BasicBatchData
from reflectorch.models.encoders.conv_encoder import ConvEncoder
from reflectorch.models.encoders.fno import FnoEncoder, FusionSelfAttention
...
class NFNetwork(nn.Module):
    ...
    def sample(self, num_samples, curves, bounds=None, q_values=None, sigmas=None, conditioning_params=None, key_padding_mask=None, unscaled_q_values=None, batch_size=None):
        """
        """
